...
PRODUCT_BUILD_PROP_OVERRIDES += PRIVATE_BUILD_DESC="eos_emulator-userdebug 10 emu-q-pub-userdebug 2020.113.2 test-keys"

# Set BUILD_FINGERPRINT variable to be picked up by both system and vendor build.prop
BUILD_FINGERPRINT := Surface/eos_emulator/eos_emulator:10/emu-q-pub-userdebug/2020.113.2:userdebug/test-keys
